              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center mb-2 gap-2">
                  ...
                  {getProjectNotesData(project.notes).revenue && (
                    <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 border border-emerald-100 flex items-center gap-0.5 shadow-sm">
                      💰 {getProjectNotesData(project.notes).revenue}
                    </span>
                  )}
                </div>
